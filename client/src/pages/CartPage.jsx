...
const CartPage = () => {
  ...
  return (
    <Layout>
      <div className="cart-page">
        <div className="row">
          <div className="col-md-12 text-center bg-light p-2 mb-1">
            <h1>
          ...
          <div className="row">
            ...
            <div className="col-md-5 cart-summary">
              ...
              {auth?.user?.address ? (
                ...
                <button className="btn btn-outline-warning" onClick={() => navigate(auth?.token ? "/dashboard/user/profile" : "/login")}>
